<%@ Page Title="" Language="C#" MasterPageFile="~/view/AdminMaster.master" AutoEventWireup="true" CodeFile="~/Controller/CatalogoAdmin.aspx.cs" Inherits="view_CatalogoAdmin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      <div class="row" style="padding-top:50px">
        <div class="col-sm-12 col-md-12" >
            <label class="col-xs-11 center espacio_cajas "  >Buscar Nombre Producto</label>
            <asp:TextBox class="form-control" runat="server" ID="TB_Filtro"  placeholder="Ingresar Usuario" AutoPostBack="True"></asp:TextBox>
