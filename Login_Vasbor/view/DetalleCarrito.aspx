<%@ Page Title="" Language="C#" MasterPageFile="~/view/AdminCatalogo.master" AutoEventWireup="true" CodeFile="~/Controller/DetalleCarrito.aspx.cs" Inherits="view_DetalleCarrito" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="padding-top:20px;">
        <div class="col-md-9">
            <h5 class="proNameViewCart"> Numero De Productos: <asp:Label ID="lb_Con"   runat="server" /></h5>
            <asp:Repeater ID="DCatalogo" runat="server" DataSourceID="OBCarrito" OnItemCommand="DCatalogo_ItemCommand"  >
                 <ItemTemplate>
      ...
      <asp:ObjectDataSource ID="OBCarrito" runat="server" SelectMethod="obtenerProductosCarrito" TypeName="DAOProducto">
                <SelectParameters>
