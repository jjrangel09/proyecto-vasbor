<%@ Page Title="" Language="C#" MasterPageFile="~/view/AdminMaster.master" AutoEventWireup="true" CodeFile="~/Controller/ReporteMeseros.aspx.cs" Inherits="view_ReporteMeseros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <CR:CrystalReportSource ID="CR_S" runat="server">
        <Report FileName="~\Reportes\ReporteMonetarioMesero.rpt">
        </Report>
