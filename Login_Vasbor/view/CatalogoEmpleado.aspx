<%@ Page Title="" Language="C#" MasterPageFile="~/view/AdminCatalogoEmpleado.master" AutoEventWireup="true" CodeFile="~/Controller/CatalogoEmpleado.aspx.cs" Inherits="view_CatalogoEmpleado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row" style="padding-top:50px">
     ...
     <asp:Repeater ID="DCatalogo" runat="server"  OnItemCommand="DCatalogo_ItemCommand" DataSourceID="ODSCatalogoempleado">
   <ItemTemplate>
       <div class="col-sm-3 col-md-3">
        ...
        <asp:ObjectDataSource ID="ODSCatalogoempleado" runat="server" SelectMethod="obtenerProductoCantidadActualE" TypeName="DAOEmpleado">
            <SelectParameters>
